...
/* #include   MVS_CODES     IS0060 do not use USA-API H file*/
#include   MVS_C_CODES   /* IS0060 Use CC H file */

/* #include   RACF_CODES     IS0060 do not use USA-API H file*/
#include   RACF_C_CODES   /* IS0060 Use CC H file */
